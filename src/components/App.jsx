...
class App extends Component {
    ...
    render() {
        const childWithProp = React.Children.map(this.props.children, (child) => {
            ...
            return path === 'work'
                ? React.cloneElement(child, {projects: this.state.projects})
                : child;
        });
        return (
            <div className="container">
                <Panel classNames='has-gears'>
                    <section className="name-container">
                        <IndexLink to="/">
                            <svg className="logo" version="1.1" viewBox="0 0 87 87" x="0" xmlns="http://www.w3.org/2000/svg" width="40">
